...
function Button({ children, disabled, type, to }) {
  ...
  const style = {
    ...
    secondary:
      "inline-block tracking-wide disabled:cursor-not-allowed rounded-full bg-stone-200 font-semibold uppercase text-stone-800 transition-colors duration-300 hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-300 focus:ring-offset-2",
