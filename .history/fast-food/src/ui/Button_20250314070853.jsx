...
function Button({ children, disabled, type, to }) {
  ...
  const base_secondary =
    base +
    "bg-stone-200 text-stone-800 border border-stone-400 hover:bg-stone-800 hover:text-stone-200 focus:bg-stone-800 focus:text-stone-200 focus:ring-stone-800 ";
