...
function Button({ children, disabled, type, to }) {
  const base =
    "inline-block tracking-wide disabled:cursor-not-allowed rounded-full transition-colors duration-300 font-semibold uppercase focus:outline-none focus:ring-2 focus:ring-offset-2 ";
  ...
  const base_secondary =
    base +
    "bg-stone-200 text-stone-800 hover:bg-stone-800 hover:text-stone-200 focus:bg-stone-800 focus:text-stone-200 focus:ring-stone-800 ";
