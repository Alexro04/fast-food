  ...
  return (
    <div className="px-4 py-3 sm:px-6 sm:py-4">
      ...
      <Form method="post" className="flex flex-col gap-4 text-stone-800">
        <div className="flex grow flex-col gap-2 sm:gap-8 md:flex-row md:items-center">
        ...
        <div className="flex flex-col gap-2 sm:gap-8 md:flex-row md:items-center">
        ...
        <div className="relative flex flex-col gap-2 sm:gap-8 md:flex-row md:items-center">
          <label>Address</label>
          <div className="grow">
            <input
              type="text"
