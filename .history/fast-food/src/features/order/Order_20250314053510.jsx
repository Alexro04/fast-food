    ...
    <div className="px-4 py-4 text-sm text-stone-800 sm:text-base">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="space-x-2">
          {priority && (
            <span className="text-bold rounded-full bg-red-200 px-3 py-1 text-red-800">
              Priority
            </span>
          )}
          <span className="text-bold rounded-full bg-red-200 px-3 py-1 text-red-800>{status} order</span>
        </div>
      </div>
