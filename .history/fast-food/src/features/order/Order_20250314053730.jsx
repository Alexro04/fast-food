    ...
    <div className="px-4 py-4 text-sm text-stone-800 sm:text-base">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="space-x-2">
          {priority && (
            <span className="rounded-full bg-red-200 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-red-800">
              Priority
            </span>
          )}
          <span className="rounded-full bg-green-200 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-green-800">
            {status} order
          </span>
        </div>
      </div>
