        ...
        <div>
          ...
          <div>
            <input
              ...
              name="address"
              required
              className="w-full rounded-full border border-stone-200 px-4 py-2 transition-all duration-300 focus:outline-none focus:ring focus:ring-yellow-300 md:px-6 md:py-3"
            />
          </div>
        </div>
